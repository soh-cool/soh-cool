...
contract MatchPairStorageStableV2 {
    ...
    function userInfoLength(uint256 _index, address _account ) external view returns(uint256) {
        UserInfo[] storage userInfos = _index == 0? userInfo0[_account] : userInfo1[_account];
