...
import "./storage/StrategyCakeStorage.sol";
...
/**
 * mine Cake via PancakeSwap.MasterChef
 * will transferOnwership to stakeGatling
 */
contract ProfitStrategyCakeDelegate is StrategyCakeStorage, Ownable, IProfitStrategy {
    ...
    function earnPending(address _account) external view override returns (uint256) {
        return IMasterChef(stakeRewards).pendingCake(pid, _account);
    }
