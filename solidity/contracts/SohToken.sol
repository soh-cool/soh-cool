...
contract SohToken is ERC20, Ownable {
    uint256 public maxMint;
    bool public mintOver;
    constructor ( uint256 _maxMint ) ERC20("SOH Finance Token V2", "SOH") public  {
        maxMint = _maxMint;
    }

    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (SohMaster).
